    ...
    <form class="space-y-4" @submit.prevent="onSubmit">
      ...
      <div class="flex flex-col">
        ...
        <textarea
          ...
          class="block w-full rounded-lg border border-slate-300 bg-white px-3 py-2 text-sm text-slate-800 placeholder-slate-400 transition-colors focus:outline-none focus:ring-2 focus:ring-terracotta focus:border-transparent hover:border-slate-400 resize-y"
        />
      </div>
